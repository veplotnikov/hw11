         ...
         docker {
           ...
           registryUrl 'http://35.214.18.4:8011'
            ...
            steps {
               ...
               sh 'mvn package'
               sh 'echo "FROM davidcaste/alpine-tomcat:jre8tomcat7" > Dockerfile && echo "ADD hello-1.0.war /opt/tomcat/webapps" >> Dockerfile && echo "CMD [\"/opt/tomcat/bin/catalina.sh\",\"run\"]"  >> Dockerfile'
